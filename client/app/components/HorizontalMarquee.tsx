    ...
    return (
        <div ref={containerRef} className="py-20 overflow-hidden whitespace-nowrap border-y border-white/5 bg-white/[0.02] relative">
            <motion.div style={{ x: movement }} className="flex">
                {[...Array(20)].map((_, i) => (
                    <span key={i} className="font-integral text-3xl md:text-5xl text-outline px-8 uppercase transition-colors hover:text-[#d4af37] tracking-[0.2em] flex items-center">
