        ...
        {projects.map((project, idx) => (
          ...
          >
            ...
            <div className="px-4 sm:px-6 md:px-8 py-6 md:py-8 flex flex-col bg-[#0f0f0f]">
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 md:mb-3 text-[#f5f5f0] font-integral tracking-[0.05em] group-hover:text-[#d4af37] transition-colors duration-500">
                {project.title}
              </h3>
